package com.example.spring.data.es;
...
import com.example.spring.data.es.config.Config;
import com.example.spring.data.es.model.Article;
import com.example.spring.data.es.model.Author;
import com.example.spring.data.es.repository.ArticleRepository;
